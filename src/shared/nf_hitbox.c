...
static void consider(
    bool hit,float distance,NfHitZone zone,
    float *nearest,NfHitZone *best){
    if(hit&&distance>=0.0f&&distance<*nearest){
        *nearest=distance;
        *best=zone;
    }
}
...
NfHitZone nf_cattler_hit_zone_for_ray(
    ...
    NfVec3 foot_min={
        actor_base.x-NF_CATTLER_WEAK_HALF_WIDTH,
        actor_base.y+NF_CATTLER_FOOT_MIN_Y,
        actor_base.z-NF_CATTLER_WEAK_HALF_WIDTH};
    NfVec3 foot_max={
        actor_base.x+NF_CATTLER_WEAK_HALF_WIDTH,
        actor_base.y+NF_CATTLER_FOOT_MAX_Y,
        actor_base.z+NF_CATTLER_WEAK_HALF_WIDTH};
    ...
    NfVec3 knee_min={
        actor_base.x-NF_CATTLER_WEAK_HALF_WIDTH,
        actor_base.y+NF_CATTLER_KNEE_MIN_Y,
        actor_base.z-NF_CATTLER_WEAK_HALF_WIDTH};
    NfVec3 knee_max={
        actor_base.x+NF_CATTLER_WEAK_HALF_WIDTH,
        actor_base.y+NF_CATTLER_KNEE_MAX_Y,
        actor_base.z+NF_CATTLER_WEAK_HALF_WIDTH};
    t=FLT_MAX;
    ...
    NfVec3 body_min={
        actor_base.x-NF_CATTLER_BODY_HALF_WIDTH,
        actor_base.y+NF_CATTLER_BODY_MIN_Y,
        actor_base.z-NF_CATTLER_BODY_HALF_WIDTH};
    NfVec3 body_max={
        actor_base.x+NF_CATTLER_BODY_HALF_WIDTH,
        actor_base.y+NF_CATTLER_BODY_MAX_Y,
        actor_base.z+NF_CATTLER_BODY_HALF_WIDTH};
    t=FLT_MAX;
    ...
    NfVec3 head={
        actor_base.x,
        actor_base.y+NF_CATTLER_HEAD_CENTER_Y,
        actor_base.z};
    t=FLT_MAX;
