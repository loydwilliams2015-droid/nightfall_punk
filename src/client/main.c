...
int main(int argc,char **argv) {
    ...
    const int width=1280,height=720; InitWindow(width,height,"nightfall!punk v1.0 topographic lifeworld lab"); SetTargetFPS(144);
