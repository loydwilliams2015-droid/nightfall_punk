...
int main(int argc,char **argv) {
    ...
    const int width=1280,height=720; InitWindow(width,height,"nightfall!punk v0.5 agent intelligence lab"); SetTargetFPS(144);
